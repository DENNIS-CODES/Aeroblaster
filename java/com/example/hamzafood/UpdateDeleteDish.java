...
//getting dish data and input it into data base
...
//findViewById is a method that finds the view from the layout resource file that are attached with current Activity. 
        ...
        final String userid = FirebaseAuth.getInstance().getCurrentUser().getUid();//Creates a new KeyGenerator instance that provides the specified key algorithm from firebase
        ...
        dataa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Update_dish.setOnClickListener(new View.OnClickListener() {//OnClickListener has just one method which is OnClick (View v). Therefore, whatever action that needs to be performed on clicking the button must be coded within this method
                    @Override
                    public void onClick(View v) {//do something when button is clicked
                        ...
                        if(isValid()){//is imageuri valid
                            if(imageuri != null){//if not null upload images
                                uploadImage();
                            }else{
                                updatedesc(dburi);
                            }
                ...
                Delete_dish.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {//set a button
                            @Override
